          ...
          children: <Widget>[
            ListView(
              ...
              style: TextStyle(
                ...
                Container(
                  height: ScreenUtil.instance.setHeight((near.length).toDouble()*140),
                  child: ListView.builder(
            ...
            Positioned(
              top:(moveup) ? 0:ScreenUtil.instance.setHeight(24),
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: (moveup) ? 0 : 16),
